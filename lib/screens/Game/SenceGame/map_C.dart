    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Image.asset(
              'assets/images/GamemapBG/GAME_C.png', // ✅ ลบ '/' หน้าพาธ
              fit: BoxFit.cover,
            ),
          ),
          ...
          Positioned(
            ...
            top: 1000,
            child: Container(
              color: const Color.fromARGB(255, 254, 212, 113),
  ...
  Widget _buildBottomButton(String label, IconData? icon, VoidCallback? onTap) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(
          child: icon != null
              ? Icon(icon, size: 30, color: Color.fromARGB(255, 254, 212, 113))
              : Text(
                  label,
                  style: const TextStyle(
                    fontSize: 30,
                    fontWeight: FontWeight.bold,
                    color: Color.fromARGB(255, 254, 212, 113),
                  ),
                ),
        ),
      ),
