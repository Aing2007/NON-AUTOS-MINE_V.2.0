...
import 'package:non_autos_mine/screens/Game/SocialGame/Level1/C.1.1.dart';
import 'package:non_autos_mine/screens/Game/SocialGame/Level1/C.1.2.dart';
import 'package:non_autos_mine/screens/Game/SocialGame/Level1/C.1.3.dart';

import '../../../AIfunction/TTS.dart';
import 'map_S.dart';

void main() {
  runApp(const STARTSscreen());
}
...
class _AingHomePageState extends State<AingHomePage>
  ...
  static const Color appPrimary = Color(0xFFF65A3B);
  static const Color appAccent = Color(0xFFF65A3B);
  static const Color appLight = Color(0xFFFFB4A6);
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    const MAPSscreen(), // 👉 ไปยังหน้าใหม่
                              ),
                            );
                          },
                          child: Container(
