                  ...
                  child: Column(
                    ...
                    children: [
                      _buildScoreLine(
                        ...
                        score: score1,
                        fontSize: scoreLineFontSize * 0.8,
                      ),
                      _buildScoreLine(
                        index: 2,
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.only(
                          topLeft: Radius.circular(bottomBarRadius * 1.2),
                          topRight: Radius.circular(bottomBarRadius * 1.2),
                        ),
                      ),
                      child: Padding(
                        padding: EdgeInsets.symmetric(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                              height: verticalPadding * 1.2,
                            ), // เว้นช่องให้ปุ่มไม่ชน
                          ],
                        ),
                      ),
                    ),
                    Positioned(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          width: arrowButtonSize * 0.8,
                          height: arrowButtonSize * 0.8,
                          decoration: BoxDecoration(
                            color: pageColor,
